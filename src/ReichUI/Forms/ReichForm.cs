...
using ReichUI.Properties;
using ReichUI.Helpers;
using ReichUI.Helpers.Cursors;
using ReichUI.Helpers.Properties.Events;
using ReichUI.Helpers.Properties.ReichForm;

namespace ReichUI.Forms
{
    public class ReichForm : Form
    {
            ...
            if (!ClientRectangle.IsEmpty)
                    ...
                    FormBackColor.GradientColor2, FormBackColor.GradientMode))
                {
                    if (RoundEdges)
                    {
                        ...
                        using (var path = Utility.RoundedRect(new Rectangle(0, 0, Width, Height), 16))
                        {

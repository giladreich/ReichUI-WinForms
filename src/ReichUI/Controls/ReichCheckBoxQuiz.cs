...
namespace ReichUI.Controls
{
    ...
    public partial class ReichCheckBoxQuiz : UserControl
    {
        private readonly ReichCheckBox[] _checkBoxes;
        ...
        public ReichCheckBoxQuiz()
        {
            InitializeComponent();
            _checkBoxes       = new ReichCheckBox[4]{ cbOption1, cbOption2, cbOption3, cbOption4 };
